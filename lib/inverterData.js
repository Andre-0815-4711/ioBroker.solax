        ...
        return new Promise(async (resolve) => {
            const data_dataPoints = {
                ...
                4: { /****************************************** X3-Hybrid-G4 *****************************************/
                    ...
                    74: { name: 'data.batteryunloadtotal', description: 'Battery Energy out total', type: 'number', multiplier: 0.1, unit: 'kWh', role: 'value.power.consumption' }, // 'Battery out Total Energy': (19, 'kWh'),
                    76: { name: 'data.batteryloadtotal', description: 'Battery Energy in total', type: 'number', multiplier: 0.1, unit: 'kWh', role: 'value.power.consumption' }, // 'Battery load Total Energy': (19, 'kWh'),
                    78: { name: 'data.batteryunloadtoday', description: 'Battery Energy out Daily', type: 'number', multiplier: 0.1, unit: 'kWh', role: 'value.power.consumption' }, // 'Today's Battery out Energy': (21, 'kWh'>
                    79: { name: 'data.batteryloadtoday', description: 'Battery Energy in Daily', type: 'number', multiplier: 0.1, unit: 'kWh', role: 'value.power.consumption' }, // 'Today's Battery load Energy': (21, 'kWh'),
